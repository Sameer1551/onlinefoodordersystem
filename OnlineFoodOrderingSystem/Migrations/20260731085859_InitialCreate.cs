        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuisineTags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgRating = table.Column<decimal>(type: "decimal(3,2)", nullable: false),
                    RatingCount = table.Column<int>(type: "int", nullable: false),
                    DeliveryTimeMinMinutes = table.Column<int>(type: "int", nullable: false),
                    DeliveryTimeMaxMinutes = table.Column<int>(type: "int", nullable: false),
                    FreeDeliveryAboveAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItems_FoodItems_FoodItemFoodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_FoodItems_FoodItemFoodId",
                        column: x => x.FoodItemFoodId,
                        principalTable: "FoodItems",
                        principalColumn: "FoodId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Wishlists_FoodItems_FoodItemFoodId",
                        column: x => x.FoodItemFoodId,
                        principalTable: "FoodItems",
                        principalColumn: "FoodId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_FoodItems_FoodItemFoodId",
                        column: x => x.FoodItemFoodId,
                        principalTable: "FoodItems",
                        principalColumn: "FoodId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_FoodItemFoodId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_FoodItemFoodId",
                table: "OrderItems",
                column: "FoodItemFoodId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_FoodItemFoodId",
                table: "Reviews",
                column: "FoodItemFoodId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_FoodItemFoodId",
                table: "Wishlists",
                column: "FoodItemFoodId");

            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_FoodId",
                table: "Wishlists",
                columns: new[] { "UserId", "FoodId" },
                unique: true);
        }
